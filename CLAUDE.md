...
## Project
Workflow experiment comparing 5 AI coding frameworks. Read `docs/RUN_LOG.md` first (the `## Next` line), then `docs/EXPERIMENT_DESIGN.md` Session Quick Start. Summarize in ≤5 bullets, wait for confirmation, do ONE sub-phase, update RUN_LOG, stop.
