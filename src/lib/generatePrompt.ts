...
function buildContextBlock(
  ...
  const startDirective = hasContests
    ? `\nYou already have my state, county if known, election details, and ballot races above. The app used my address outside this chat to resolve official civic data, but my exact address is intentionally not included here. Treat the listed races as my definitive ballot. Do NOT ask me for my exact address, full name, phone, email, or other identifying details. Follow Step 1 exactly: explain why this election matters in daily life and show a compact ballot check. Then automatically choose the highest-impact confirmed race and use the required first-race evidence summary from the prompt. Do NOT ask which race I want to start with unless I explicitly ask to pick the order. Do NOT ask a vague "what matters most?" laundry-list question. Do NOT fabricate races, candidates, voting records, donors, or ballot measures.${partyChoiceDirective}`
    : hasUserSampleBallot
      ? `\nYou already have my state, county if known, election details, official election links, and user-provided sample ballot text above. The app used my address outside this chat, but my exact address is intentionally not included here. Do NOT ask me for my exact address, full name, phone, email, or other identifying details. Treat the pasted sample ballot text as the working ballot for Step 1, while clearly saying it was user-provided and not API-confirmed. Explain why this election matters and show a compact ballot check from the pasted text. Then automatically choose the highest-impact confirmed race and use the required first-race evidence summary from the prompt. Do NOT ask which race I want to start with unless I explicitly ask to pick the order. Do NOT ask a vague "what matters most?" laundry-list question. Do NOT fabricate missing races, candidates, voting records, donors, or ballot measures.${partyChoiceDirective}`
      : `\nYou already have my state, county if known, election details, and official election links above. The app used my address outside this chat, but my exact address is intentionally not included here. Do NOT ask me for my exact address, full name, phone, email, or other identifying details. ${county ? `My county is ${county}.` : "Use only the coarse location above."} The app did NOT confirm an exact contest list, so do not claim you have my exact ballot yet. This means Google Civic did not return contests for this lookup; it does NOT mean the county has no races. Follow Step 1: explain why this election could matter, show only high-level ballot/source status, and give one clear bullet-list CTA to use the county sample ballot link or paste text copied from the official PDF. Include the full county ballot URL as a clickable markdown link with the URL visible. Do NOT ask which race I want to start with while the ballot is still unconfirmed. Once the ballot is confirmed, automatically choose the highest-impact confirmed race and use the required first-race evidence summary from the prompt. Do NOT ask a vague "what matters most?" laundry-list question. Do NOT fabricate races, candidates, voting records, donors, or ballot measures.${partyChoiceDirective}`;
