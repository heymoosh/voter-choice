...
const en: Translations = {
  ...
  zipForm: {
    ...
    privacy:
      "Privacy: your address may be sent to the US Census Bureau (for your voting district) and to Google Places/Civic (to find your ballot and polling places). We do not store it or send it to the AI chat, so we do not have a combined record of where you live and what you say.",
  },
  loading: "Loading...",
  errors: {
...
const es: Translations = {
  ...
  zipForm: {
    ...
    privacy:
      "Privacidad: tu direcci\u00f3n puede enviarse a la Oficina del Censo de EE. UU. (para tu distrito electoral) y a Google Places/Civic (para encontrar tu boleta y casillas). No la almacenamos ni la enviamos al chat de IA, as\u00ed que no tenemos un registro combinado de d\u00f3nde vives y lo que dices.",
  },
  loading: "Cargando...",
  errors: {
