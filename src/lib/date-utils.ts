...
export function getDeadlineStatus(deadline: string | null, today: Date = new Date()): DeadlineStatus {
...
export function getDeadlineLabel(deadline: string | null, today: Date = new Date()): string {
