// @ts-nocheck
"use client";
/* AUTO-GENERATED from /prototype/*.jsx — VERBATIM concatenation in HTML load order.
   Do not hand-edit the UI here; edit the prototype source + regenerate, OR
   replace the marked mock-data seams during backend wiring (Phase 2). */
