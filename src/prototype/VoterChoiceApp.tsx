...
const TRANSLATIONS = {
  en: {
    ...
    scorecardPrint: {
      ...
      decisionNoteVotes: 'Voted with you on {kept} of {total} key votes',
      decisionNoteSmallDonor: 'small-donor funded',
      decisionNoteIncumbentMatch: 'Replacing the incumbent ({pct}% match)',
  ...
  es: {
    ...
    scorecardPrint: {
      ...
      decisionNoteVotes: 'Coincidió contigo en {kept} de {total} votos clave',
      decisionNoteSmallDonor: 'financiado por pequeños donantes',
      decisionNoteIncumbentMatch: 'Reemplazando al titular (coincidencia del {pct}%)',
