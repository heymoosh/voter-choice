...
const TRANSLATIONS = {
  en: {
    ...
    scorecard: {
      ...
      printGate: 'Decide {done} of {total} to print',
    ...
    orientation: {
      ...
      metaMinutes: '~4 min',
      metaSeatSingular: '{n} seat up in 2026',
      metaSeatsPlural: '{n} seats up in 2026',
    },
  },
  es: {
    nav: {
    ...
    scorecard: {
      ...
      printGate: 'Decide {done} de {total} para imprimir',
    ...
    repCard: {
      ...
      provRollCall: 'Historial de votación nominal',
    ...
    orientation: {
      ...
      lede: 'Tres personas en Washington responden a tu dirección. Revisarás el historial de cada una — y luego decidirás.',
      step1Title: 'Mira el historial, no el nombre',
      step1Body: 'Cómo votaron en tus temas, cómo se financian y quién los influye — sin revelar su identidad.',
      step2Title: 'Decide: mantener o reemplazar',
      step2Body: 'Una decisión por puesto. Si decides reemplazar, compara a quienes se postulan.',
      step3Title: 'Imprime tu tarjeta de puntuación',
      step3Body: 'Termina los puestos en juego en esta elección y llévala a las urnas.',
      continueLabel: 'Comienza con tu primer puesto',
      metaMinutes: '~4 min',
      metaSeatSingular: '{n} puesto en juego en 2026',
      metaSeatsPlural: '{n} puestos en juego en 2026',
    },
  },
};
