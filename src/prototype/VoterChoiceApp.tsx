...
const TRANSLATIONS = {
  en: {
    ...
    repCard: {
      ...
      canCuratedContext: 'Curated context',
      canRaceRatingsKeyVotes: 'Race ratings & key votes',
      canRatingTossUp: 'Toss-up',
      canRatingLeanD: 'Lean D',
      canRatingLeanR: 'Lean R',
      canRatingLikelyD: 'Likely D',
      canRatingLikelyR: 'Likely R',
      canRatingSafeD: 'Safe D',
      canRatingSafeR: 'Safe R',
      canDonorTrailLabel: 'DONOR TRAIL',
      canRaised: 'Raised',
      canPacShareSuffix: ' · ~{pct}% from PACs',
    },
    handoffModal: {
  ...
  es: {
    ...
    repCard: {
      ...
      canCuratedContext: 'Contexto curado',
      canRaceRatingsKeyVotes: 'Calificaciones de la contienda y votos clave',
      canRatingTossUp: 'Empate',
      canRatingLeanD: 'Favorece D',
      canRatingLeanR: 'Favorece R',
      canRatingLikelyD: 'Probable D',
      canRatingLikelyR: 'Probable R',
      canRatingSafeD: 'Segura D',
      canRatingSafeR: 'Segura R',
      canDonorTrailLabel: 'RUTA DE DONANTES',
      canRaised: 'Recaudó',
      canPacShareSuffix: ' · ~{pct}% de PACs',
    },
    handoffModal: {
