...
function PrivacyPage({ onBack }) {
  return (
    <StaticPage onBack={onBack} eyebrow="Privacy policy" title="What stays here, what doesn't.">
      ...
      <h2>Your address</h2>
      <p>If you enter your street address, it may be used for autocomplete (Google Places) in your browser, is sent to the <b>US Census Bureau</b> geocoder through our server to look up your voting district (your state, county, and congressional district), and is sent to the <b>Google Civic Information API</b> through our server for polling-place and contest lookup. We do not intentionally log or store your address on our servers, and we do not include it in the AI chat prompt. In your browser it is held only for the current tab and cleared when you close it — only a county-level location is kept across visits.</p>
