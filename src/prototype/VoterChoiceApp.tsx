...
const TRANSLATIONS = {
  en: {
    ...
    scorecard: {
      ...
      yourHouseSeatTitle: 'Your U.S. House seat',
      yourSenateSeatTitle: 'Your U.S. Senate seat',
      federalPill: 'Federal',
      houseSeatDesc: "One representative for {district}. They vote on federal law — healthcare, housing, spending. Here's their record against your issues.",
      senateSeatDesc: "One of two senators for {state}. They vote on federal law — healthcare, housing, spending. Here's their record against your issues.",
      backToSeats: '← Seats',
      decidedCount: '{n} of {total} decided',
      groupReviewingNow: 'Reviewing now',
      groupNotUpForElection: 'Not up for election',
      tagNow: 'Now',
      tagUpNext: 'Up next',
      bothSeats: 'both seats',
      allSeats: 'all seats',
      printCaption: 'Decide {word} to print · {n} of {total}',
    },
    editIssues: {
    ...
    repCard: {
      ...
      worthKeepingUndo: 'Keep — undo',
      worthKeeping: 'Keep',
      replacingWith: 'Replacing with {name} — change',
      timeToReplaceChange: 'Replace — change',
      timeToReplaceCompare: "Replace — compare who's running →",
      timeToReplace: 'Replace',
      seatIncumbentHeading: "This seat's incumbent",
      seatIncumbentSub: 'Name & party hidden — judge the record, not the person',
      ...
      termWord: 'term',
      termsWord: 'terms',
      votedWithYouLabel: 'Voted with you',
      keyVotesFraction: '{n} / {m} key votes',
      attCmpAbove: 'above',
      attCmpNear: 'near',
      attCmpBelow: 'below',
      attendanceCompareLine:
        'Missed <b>{pct}%</b> of floor votes this term — <b>{cmp}</b> the {chamber} median',
      attPillAbove: 'Above average',
      attPillNear: 'About average',
      attPillBelow: 'Below average',
      fundingLabel: 'Funding',
      pacFundedTop: '{pct}% PAC-funded · top: {sectors}',
      raisedCycle: 'raised · {cycle}',
      medianMultiplePill: '≈{mult} the median {chamber} campaign',
    },
    handoffModal: {
    ...
    orientation: {
      kick: 'Before you start · step 3 of 3',
      heading: 'Here’s how you’ll <em>hold your delegation to account</em>.',
      body: 'Three people in Washington answer to your address. You’ll look at each one’s record — then decide.',
      step1Title: 'See the record, not the name',
      step1Body: 'How they voted on your issues, how they’re funded, who’s influencing them — shown blind.',
      step2Title: 'Decide: keep, or replace',
      step2Body: 'One call per seat. If you’d replace them, compare the people running.',
      step3Title: 'Print your scorecard',
      step3Body: 'Finish the seats up for election, then take it to the polls.',
      continueLabel: 'Start with your first seat →',
      meta: '~4 min · {seats} seats up in 2026',
      metaOne: '~4 min · {seats} seat up in 2026',
    },
  },
  es: {
    nav: {
    ...
    scorecard: {
      ...
      yourHouseSeatTitle: 'Tu escaño en la Cámara de EE.UU.',
      yourSenateSeatTitle: 'Tu escaño en el Senado de EE.UU.',
      federalPill: 'Federal',
      houseSeatDesc: 'Un representante para {district}. Votan leyes federales — salud, vivienda, gasto público. Aquí está su historial frente a tus temas.',
      senateSeatDesc: 'Uno de dos senadores por {state}. Votan leyes federales — salud, vivienda, gasto público. Aquí está su historial frente a tus temas.',
      backToSeats: '← Escaños',
      decidedCount: '{n} de {total} decididos',
      groupReviewingNow: 'Revisando ahora',
      groupNotUpForElection: 'No está en la boleta',
      tagNow: 'Ahora',
      tagUpNext: 'Sigue',
      bothSeats: 'ambos escaños',
      allSeats: 'todos los escaños',
      printCaption: 'Decide {word} para imprimir · {n} de {total}',
    },
    editIssues: {
    ...
    repCard: {
      ...
      worthKeepingUndo: 'Mantener — deshacer',
      worthKeeping: 'Mantener',
      replacingWith: 'Reemplazando con {name} — cambiar',
      timeToReplaceChange: 'Reemplazar — cambiar',
      timeToReplaceCompare: 'Reemplazar — comparar quién se postula →',
      timeToReplace: 'Reemplazar',
      seatIncumbentHeading: 'El titular de este escaño',
      seatIncumbentSub: 'Nombre y partido ocultos — juzga el historial, no a la persona',
      revealNameBtn: 'Revelar nombre',
      yourPrefix: 'Tu',
      roleRepresentative: 'Representante',
      roleSenator: 'Senador/a',
      termWord: 'período',
      termsWord: 'períodos',
      votedWithYouLabel: 'Votó contigo',
      keyVotesFraction: '{n} / {m} votos clave',
      attCmpAbove: 'por encima de',
      attCmpNear: 'cerca de',
      attCmpBelow: 'por debajo de',
      attendanceCompareLine:
        'Faltó a <b>{pct}%</b> de las votaciones en el pleno este período — <b>{cmp}</b> la mediana de {chamber}',
      attPillAbove: 'Por encima del promedio',
      attPillNear: 'En el promedio',
      attPillBelow: 'Por debajo del promedio',
      fundingLabel: 'Financiamiento',
      pacFundedTop: '{pct}% financiado por PACs · principal: {sectors}',
      raisedCycle: 'recaudado · {cycle}',
      medianMultiplePill: '≈{mult} la mediana de campañas de {chamber}',
    },
    handoffModal: {
    ...
    orientation: {
      kick: 'Antes de empezar · paso 3 de 3',
      heading: 'Así es como <em>harás responsable a tu delegación</em>.',
      body: 'Tres personas en Washington responden a tu dirección. Verás el historial de cada una — y luego decidirás.',
      step1Title: 'Mira el historial, no el nombre',
      step1Body: 'Cómo votaron en tus temas, cómo se financian, quién los influye — mostrado a ciegas.',
      step2Title: 'Decide: mantener o reemplazar',
      step2Body: 'Una decisión por puesto. Si decides reemplazarlo, compara a quienes se postulan.',
      step3Title: 'Imprime tu tarjeta de puntuación',
      step3Body: 'Termina los puestos en elección este año, y llévala a las urnas.',
      continueLabel: 'Empieza con tu primer puesto →',
      meta: '~4 min · {seats} puestos en elección en 2026',
      metaOne: '~4 min · {seats} puesto en elección en 2026',
    },
  },
};
