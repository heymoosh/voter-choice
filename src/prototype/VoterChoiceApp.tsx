...
import {
  ...
  setCandidateResearch,
  getBallotLogistics,
  setBallotLogistics,
  getLowConfidenceExtraction,
  setLowConfidenceExtraction,
...
function AppNav({ onBrandClick }) {
  ...
  const i18n =
    typeof useI18n === "function"
      ? useI18n()
      : { t: (k) => k.split(".").pop() };
  const nav =
    typeof useNav === "function"
      ? useNav()
      : { openSettings: () => {}, navigate: () => {}, current: "home" };
  const { t } = i18n;
    ...
    <nav className="app-nav" data-current={current || "home"} aria-label="Main">
      ...
      <div className="links">
        <a
          ...
          tabIndex={0}
          onKeyDown={(e) => {
            if (e.key === "Enter") navigate("howitworks");
          }}
        >
          {t("nav.howItWorks")}
        </a>
        <a
          ...
          tabIndex={0}
          onKeyDown={(e) => {
            if (e.key === "Enter") navigate("methodology");
          }}
        >
          {t("nav.methodology")}
        </a>
...
function AppFooter({ compact }: { compact?: boolean }) {
  ...
  return (
    <footer className={"hp-foot" + (compact ? " hp-foot-slim" : "")}>
      ...
      <ul>
        <li>
          <a onClick={() => navigate("methodology")} role="link" tabIndex={0}>
            Methodology
          </a>
        </li>
        <li>
          <a onClick={() => navigate("about")} role="link" tabIndex={0}>
            About
          </a>
        </li>
        <li>
          <a onClick={() => navigate("privacy")} role="link" tabIndex={0}>
            Privacy
          </a>
        </li>
        <li>
        ...
        <li>
          <a onClick={() => navigate("tip")} role="link" tabIndex={0}>
            Tip jar
          </a>
        </li>
        <li>
          <a href="mailto:muxin.li.pro@gmail.com">Support</a>
        </li>
      </ul>
...
function IssueRow({
  ...
  function isInteractive(target) {
    return (
      !!target.closest && !!target.closest("button, input, a, textarea, select")
    );
  }
  function onHandleDown(e) {
    ...
    if (
      ...
      !e.target.closest(".drag-handle, .theme-row")
    )
      return;
  ...
  return (
    <div
      ...
      className={
        "theme-row" +
        (dragging ? " dragging" : "") +
        (dropIdx === index && !dragging ? " drop-target" : "")
      }
        ...
        <div className="nm">
          {editing ? (
            ...
            <>
              ...
              <button className="edit-pencil" onClick={() => setEditing(true)}>
                rename
              </button>
            </>
          )}
...
function CandidateCard({
  ...
  const totalVotes =
    alignmentEntry?.issues?.reduce(
      (n, i) => n + (i.contributingVotes?.length || 0),
      0,
    ) || 0;
    ...
    <div className="cv2-card" data-testid="candidate-card">
      ...
      <AlignmentScoreBanner
        ...
        onToggleIssue={(canonicalIssue) =>
          setExpandedIssue(
            expandedIssue === canonicalIssue ? null : canonicalIssue,
          )
        }
        anonCtx={anonCtx}
        research={research}
      ...
      {hasAnyScore && (
        <div className="cv2-see-all-bridge">
          <button className="cv2-see-all-inline" onClick={onSeeAllVotes}>
      ...
      <div className={"cv2-disclose " + (moneyOpen ? "open" : "")}>
        ...
        >
          <span className="cv2-disclose-lab">
            ...
            <span
              className="cv2-disclose-summary"
              data-testid="funding-summary"
            >
                ...
                <span className="cv2-disclose-stat">
                  ...
                  {(() => {
                    const peer = computePeerLabel(
                      candidate.totalRaised,
                      peerTotals,
                    );
                    return peer ? (
                      <>
                        {" "}
                        <span className="cv2-disclose-peer">· {peer}</span>
                      </>
                    ) : null;
                  })()}
                </span>
      ...
      <div className="cv2-actions">
        {picked ? (
          ...
          >
            <span className="ck">☐</span>
            <span>
              Pick {blindMode ? alias : candidate.name.split(" ").pop()}
            </span>
          </button>
        )}
      </div>
  ...
  return (
    <div className="fmix">
      ...
      <div className="fmix-legend">
        <div>
          <span className="sw small" /> <b>{mix.small}%</b> Small donors{" "}
          <small>&lt;$200</small>
        </div>
        <div>
          <span className="sw large" /> <b>{mix.large}%</b> Large donors{" "}
          <small>≥$200</small>
        </div>
        <div>
          <span className="sw pac" /> <b>{mix.pac}%</b> PACs{" "}
...
function namedIssuePacSummary(donorCoalition) {
  const issuePACs = (donorCoalition || []).filter(
    (slice) => slice && slice.isIssuePAC,
  );
  if (issuePACs.length === 0) return null;
  const total = issuePACs.reduce(
    (sum, slice) => sum + (typeof slice.amount === "number" ? slice.amount : 0),
    0,
  );
  const plural =
    issuePACs.length === 1 ? "named issue PAC" : "named issue PACs";
...
function CandidateCardHeader({
  ...
  return (
    <div className="cv2-head">
      ...
      {isRevealed ? (
        <button
          className="cv2-reveal hide"
          onClick={onHide}
          title="Hide this candidate again"
        >
          <svg
            className="reveal-ic"
            viewBox="0 0 24 24"
...
function AlignmentScoreBanner({
      ...
      return (
        <div className="cv2-issues" data-testid="research-pending-skeleton">
          ...
          >
            ...
            />
            <span
              style={{ fontStyle: "italic", opacity: 0.7, fontSize: "13px" }}
            >
      ...
      <div className="cv2-issues">
        ...
        <div className="cv2-norecord">
          ...
          (research.status === "unavailable" ||
            ...
            <>
              <p>
                We couldn't find citable public statements for this candidate on
                your issues.
              </p>
              <p>
                Judge instead on the candidate's own materials and the donor
                base below.
              </p>
            </>
          ) : isPending ? (
            ...
            <>
              <p>{reason}.</p>
              <p>
                Judge instead on the public statements they've made and the
                donor base below.
              </p>
            </>
          )}
  ...
  const overallPct = scored.length
    ? Math.round(
        scored.reduce((s, r) => s + (r.score.kept / r.score.total) * 100, 0) /
          scored.length,
      )
    : null;
...
function AlignmentIssueRow({
  ...
  if (score && score.sourceType === "web_search") {
    ...
    if (stance === "in_favor") {
      ...
      var proseAligns = !/\b(oppos|against|repeal|block|ban|cut)\b/i.test(
        score.resolvedStance || "",
      );
      directionLabel = proseAligns ? "ALIGNED" : "OPPOSED";
      directionColor = proseAligns
        ? "oklch(0.40 0.12 145)"
        : "oklch(0.50 0.15 25)";
    }
            ...
            <div className="meta">
              {stance === "in_favor"
                ...
                : stance === "opposed"
                  ...
                  : stance === "mixed"
                    ? "Mixed record on this issue"
                    : stance === "unclear"
                      ? "Position unclear — limited public record"
                      : score.resolvedStance}
            </div>
  ...
  return (
    <div
      className={
        "cv2-iss-row" + (isOpen ? " open" : "") + (hasVotes ? " has-drill" : "")
      }
      data-testid="voting-record-alignment-row"
    >
      <button
      ...
      >
        <div className="topic">
          ...
          {score && score.total > 0 ? (
            <div className="meta">
              Aligned on <b>{score.kept}</b> of <b>{score.total}</b>{" "}
...
function AlignmentDrilldown({ score, candidate, anonCtx }) {
  const pct =
    score && score.total > 0 ? Math.round((score.kept / score.total) * 100) : 0;
  ...
  const issuePacs = (candidate.donorCoalition || []).filter(
    (slice) =>
      slice.isIssuePAC &&
      (slice.relevantToIssue === score.canonicalIssue ||
    ...
    <div className="cv2-drill">
      ...
      {issuePacs.length > 0 && (
        <div className="cv2-issue-pacs">
          <div className="lab">Issue PACs funding {candidateLabel} on this</div>
          {issuePacs.map((p, i) => (
  ...
  return (
    <div className="cv2-vote">
      <div className="cv2-vote-head">
        <div className="bill">
          {(() => {
            ...
            const billTtl = hasNum
              ? vote.billTitle.split(" · ")[1]
              : vote.billTitle || "";
            return (
              <>
                <span className="num">{billNum}</span>
                <span className="ttl">{billTtl}</span>
              </>
            );
          })()}
        </div>
      ...
      {vote.memberRationale && vote.memberRationale.text && (
        <div className="cv2-member-rationale">
          ...
          <div className="cv2-rationale-attribution">
            <span className="cv2-rationale-source-label">
              Based on their press release
            </span>
            {(vote.memberRationale.sourceUrls || [])
              .slice(0, 2)
              .map((url, si) => (
                <a
                  key={si}
      ...
      <div className="cv2-vote-cite">
        ...
        {(vote.sources || [])
          .filter((s) => s.url !== vote.source.url)
          .map((s, si) => (
            <span key={si}>
...
function FunderBars({
  ...
  if (!donorCoalition && donorUnavailable) {
    return (
      <div className="cv2-funding" data-testid="funding-unavailable">
        <div className="cv2-block-head">
          <div className="lab">Funding mix</div>
        </div>
        <p
          style={{
            fontSize: 14,
  ...
  if (onlyTotalReceipts) {
    const total =
      typeof totalRaised === "number" ? totalRaised : industries[0]?.amount;
    return (
      <div className="cv2-funding" data-testid="funding-sparse">
        <div className="cv2-block-head">
          <div className="lab">
            Funding mix <small className="cv2-sub-lab">details pending</small>
          </div>
          <div className="overall">
        ...
        <p style={{ fontSize: 14, color: "var(--ink-3)", margin: 0 }}>
          Detailed donor breakdown is not available yet for this candidate. We
          have total receipts from filings, but not small donor, large donor,
          PAC, or sector buckets.
        </p>
        {donorSource && (
          <div
            style={{
  ...
  const impliedPacTotal =
    fundingMix && typeof totalRaised === "number"
      ? Math.round(totalRaised * (fundingMix.pac / 100))
      : null;
  const uncatPacTotal =
    impliedPacTotal !== null
      ? Math.max(0, impliedPacTotal - namedPacTotal)
      : null;
  const pctIdentified =
    impliedPacTotal && impliedPacTotal > 0
  ...
  const peerLabel = peerCmp
    ? { kind: peerCmp.kind, text: peerCmp.label }
    : null;
  // Scale: total widths in the head-to-head map are normalized to the LARGER of the two totals
  const peerScaleMax = peerCandidate
    ? Math.max(totalRaised, peerCandidate.total)
    : totalRaised;
  ...
  return (
    <div className="cv2-funding">
      <div className="cv2-block-head">
        <div className="lab">
          Funding mix <small className="cv2-sub-lab">by source type</small>
        </div>
        <div className="overall">
          ...
          {!(fundingMix && peerCandidate && peerLabel) &&
            totalRaised !== undefined && <b>{formatDollars(totalRaised)}</b>}
          {!(fundingMix && peerCandidate && peerLabel) &&
            totalRaised !== undefined &&
            fundingMix?.cycle && <> · </>}
          {fundingMix?.cycle && (
            <span className="cv2-cycle">{fundingMix.cycle}</span>
          )}
        </div>
      </div>
          ...
          return (
            <div className={"cv2-compare-rails " + peerLabel.kind}>
              ...
              <div className="cv2-cr-headline">
                ...
                <span className="cv2-cr-ctx">
                  raised than {peerCandidate.aliasOrName}
                </span>
              </div>
              <div className="cv2-cr-rail-row this">
                <span className="cv2-cr-total">
                  {formatDollars(totalRaised)}
                </span>
                <div className="cv2-cr-rail-track">
                  <div
                    className="cv2-cr-rail this-rail"
                    style={{ width: thisPct + "%" }}
                    role="img"
                  ...
                  >
                    <div
                      className="seg small"
                      style={{ flexBasis: fundingMix.small + "%" }}
                    >
                      {showSegLabel(fundingMix.small) && (
                        <span className="pct">{fundingMix.small}%</span>
                      )}
                    </div>
                    <div
                      className="seg large"
                      style={{ flexBasis: fundingMix.large + "%" }}
                    >
                      {showSegLabel(fundingMix.large) && (
                        <span className="pct">{fundingMix.large}%</span>
                      )}
                    </div>
                    <div
                      className="seg pac"
                      style={{ flexBasis: fundingMix.pac + "%" }}
                    >
                      {showSegLabel(fundingMix.pac) && (
                        <span className="pct">{fundingMix.pac}%</span>
                      )}
                    </div>
                  </div>
                </div>
              ...
              <div className="cv2-cr-rail-row peer">
                <span className="cv2-cr-total">
                  {formatDollars(peerCandidate.total)}
                </span>
                <div className="cv2-cr-rail-track">
                  <div
                    className="cv2-cr-rail peer-rail"
                    style={{ width: peerPct + "%" }}
              ...
              <div className="cv2-money-legend cv2-cr-legend">
                <div>
                  <span className="sw small" /> <b>{fundingMix.small}%</b> Small
                  donors <small>&lt;$200</small>
                </div>
                <div>
                  <span className="sw large" /> <b>{fundingMix.large}%</b> Large
                  donors <small>≥$200</small>
                </div>
                <div>
                  <span className="sw pac" /> <b>{fundingMix.pac}%</b> PACs{" "}
                  <small>groups &amp; lobbies</small>
                </div>
              </div>
      ...
      {issuePACs.length > 0 && (
        <div className="cv2-named-pacs">
          ...
          {issuePACs.map((p, i) => {
            ...
            const derivedPacStance =
              userIssue?.stance && p.issuePacStance
                ? p.issuePacStance === userIssue.stance
                  ? "with"
                  : "against"
                : p.pacStance;
            const showAlignment = !!userIssue && !!derivedPacStance;
            const conflictsWithUser =
              showAlignment && derivedPacStance === "against";
            return (
              <div className="cv2-pac-row v2" key={i}>
                <div className="cv2-pac-top">
                  <span
                    className="sw"
                    style={{ background: issuePACSwatch(relevantIssue) }}
                  />
                  <span className="name">{p.label}</span>
                  <span className="amt">{formatDollars(p.amount)}</span>
                </div>
                ...
                {showAlignment && (
                  <div
                    className={
                      "cv2-pac-flag " +
                      (conflictsWithUser ? "conflict" : "align")
                    }
                  >
                    ...
                    <span className="msg">
                      {conflictsWithUser ? (
                        <>
                          Conflicts with your priority:{" "}
                          <b>{userIssue.interpretation}</b>
                        </>
                      ) : (
                        <>
                          Aligns with your priority:{" "}
                          <b>{userIssue.interpretation}</b>
                        </>
                      )}
                    </span>
      ...
      {impliedPacTotal !== null &&
        ...
        (issuePACs.length === 0 ? (
          <div className="cv2-pac-gap">
            ...
            <span>
              About <b>{formatDollars(impliedPacTotal)}</b> ({fundingMix.pac}%)
              came from PACs, but we haven't yet identified specific issue-PACs
              behind that money. We only name PACs when we can attribute them to
              a public agenda — see the industry breakdown below for the
              categorical view.
            </span>
          </div>
          ...
          <div className="cv2-pac-gap partial">
            <span className="ic">!</span>
            <span>
              Named PACs above account for <b>{formatDollars(namedPacTotal)}</b>{" "}
              of an estimated <b>{formatDollars(impliedPacTotal)}</b> in total
              PAC money ({pctIdentified}%). The remaining{" "}
              <b>{formatDollars(uncatPacTotal)}</b> hasn't been editorially
              curated yet — it may include other issue-PACs we haven't profiled.
          ...
          return (
            <div className="cv2-industry">
              <div className="lab">
                Industry breakdown
                <small className="cv2-sub-lab">
                  all contributions grouped by sector (individuals + PACs
                  combined)
                </small>
              </div>
                  ...
                  <div className="row other" key="other">
                    ...
                    <span className="name">
                      ...
                      <small>
                        ...
                        don&rsquo;t fit a single sector tag. They&rsquo;re
                        counted in the Funding mix bar above.
                      </small>
                    </span>
                    <span className="pct">{otherPct}%</span>
                    <span className="amt">
                      {otherAmt !== null ? formatDollars(otherAmt) : "—"}
                    </span>
                  </div>
                )}
              </div>
  ...
  if (!detail && race.section === "Judicial Retention") {
    return (
      <div className="prop-card" data-testid="judicial-retention">
        ...
        <p className="sub">
          A retention vote asks whether this judge should stay in office. Vote{" "}
          <b>Yes</b> to keep them, <b>No</b> to remove them.
        </p>
      ...
      {kindMeta && (
        <div className={"prop-kind " + kindMeta.tone}>
          <div className="prop-kind-head">
            ...
            {detail.state && (
              <span className="prop-kind-state">{detail.state}</span>
            )}
          </div>
...
function TweaksPanel({ tweaks, onChange, hidden, onClose }) {
  ...
  const label =
    tweaks.mood[0].toUpperCase() +
    tweaks.mood.slice(1) +
    " · " +
    {
      civic: "Civic green",
      constitutional: "Const. ink",
      newsprint: "Newsprint",
    }[tweaks.palette] +
    " · " +
    ...
    <aside className="tweaks">
      ...
      <div className="body-inner">
        <div className="row">
          ...
          <div className="seg">
            <button
              className={tweaks.mood === "editorial" ? "active" : ""}
              onClick={() => onChange({ mood: "editorial" })}
            >
              Editorial
            </button>
            <button
              className={tweaks.mood === "civic" ? "active" : ""}
              onClick={() => onChange({ mood: "civic" })}
            >
              Civic
            </button>
            <button
              className={tweaks.mood === "manifesto" ? "active" : ""}
              onClick={() => onChange({ mood: "manifesto" })}
            >
              Manifesto
            </button>
          </div>
        ...
        <div className="row">
          ...
          <div className="seg">
            <button
              className={tweaks.palette === "civic" ? "active" : ""}
              onClick={() => onChange({ palette: "civic" })}
            >
              Civic green
            </button>
            <button
              className={tweaks.palette === "constitutional" ? "active" : ""}
              onClick={() => onChange({ palette: "constitutional" })}
            >
              Const. ink
            </button>
            <button
              className={tweaks.palette === "newsprint" ? "active" : ""}
              onClick={() => onChange({ palette: "newsprint" })}
            >
              Newsprint
            </button>
          </div>
        ...
        <div className="row">
          ...
          <div className="seg two">
            <button
              className={tweaks.treatment === "daylight" ? "active" : ""}
              onClick={() => onChange({ treatment: "daylight" })}
            >
              Daylight
            </button>
            <button
              className={tweaks.treatment === "inkwell" ? "active" : ""}
              onClick={() => onChange({ treatment: "inkwell" })}
            >
              Inkwell
            </button>
          </div>
...
function downloadIcsForElection(stateData, pollingInfo) {
  ...
  const el =
    findUpcomingElection(stateData.elections) || stateData.elections[0];
  if (!el) return;
        ...
        <div className="pb-left">
          ...
          {pollingInfo.district && (
            <>
              ...
              <span className="pb-district" data-testid="district-label">
                {pollingInfo.district}
              </span>
            </>
          )}
          ...
          <div className="pbp-actions">
            ...
            {pollingInfo.address ? (
              ...
              <a
                className="pbp-act"
                href={
                  stateData.resources?.pollingPlaceLookup ||
                  stateData.resources?.countyElectionLookup ||
            ...
            <div className="pbp-cell">
              ...
              <div className="pbp-v pbp-bring">
                {!stateData.votingRules.idRequired ? (
                  ...
                  <span>
                    {stateData.votingRules.idNote || "ID required."} Confirm the
                    accepted-ID list at your state election office.
                  </span>
                )}
              </div>
...
function PartyGate({ stateName, electionDate, rule, onPick, onSkip }) {
  ...
  const ruleLede = (() => {
    ...
    if (rule.electionType === "runoff") {
      return (
        <>
          This runoff is <b>party-locked</b>: if you voted in a party's
          first-round primary, you may only vote in that party's runoff. Pick
          the runoff you're eligible for and we'll research those races.
        </>
      );
    }
    if (rule.category === "closed") {
      return (
        <>
          {stateName || "Your state"} holds <b>closed primaries</b> — you vote
          in the primary of the party you're registered with. Pick your
          registered party and we'll research those races. The general election
          is unaffected.
        </>
      );
    }
    if (rule.category === "semi-closed") {
      return (
        <>
          {stateName || "Your state"} holds <b>semi-closed primaries</b> —
          registered party members vote their own party's primary; unaffiliated
          voters may choose one. Pick the primary you'll vote in and we'll
          research those races. The general election is unaffected.
        </>
      );
    }
    return null;
      ...
      <div className="pg-wrap">
        <div className="pg-card">
          ...
          <p className="pg-lede">
            {ruleLede ?? (
              <>
                Your ballot includes <b>both parties' primary contests</b>. A
                primary is party-specific — choose the primary you're eligible
                to vote in and we'll research only those races. The general
          ...
          <div className="pg-options">
            <button className="pg-opt dem" onClick={() => onPick("Democratic")}>
              ...
              <div className="pg-l">
                ...
                <div className="pg-sub">
                  Research the Democratic races on your ballot.
                </div>
              </div>
            ...
            <button className="pg-opt rep" onClick={() => onPick("Republican")}>
              ...
              <div className="pg-l">
                ...
                <div className="pg-sub">
                  Research the Republican races on your ballot.
                </div>
              </div>
              <span className="pg-arrow">→</span>
            </button>
            <button className="pg-opt nope" onClick={onSkip}>
              <div className="pg-l">
                ...
                <div className="pg-sub">
                  Don't filter — research all races on the ballot.
                </div>
              </div>
              <span className="pg-arrow">→</span>
            </button>
          ...
          <p className="pg-foot">
            ...
            {rule?.externalResources?.sosVoterLookupUrl ? (
              ...
              <>
                ...
                if you're unsure which primary you can vote in.
              </>
            )}
          </p>
        </div>
    ...
    <div className="amend-modal">
      <div className="amend-card">
        <header className="amend-head">
          ...
          <button className="amend-x" onClick={onCancel} aria-label="Close">
            ×
          </button>
        </header>

        <p className="amend-help">
          Re-rank, rename, remove, or add issues. When you save, I'll re-score
          every candidate you've already picked and surface any whose score
          shifts past the noise floor.
        </p>
        ...
        <footer className="amend-foot">
          <button className="amend-cancel" onClick={onCancel}>
            Cancel
          </button>
          <button
            className="amend-apply"
  ...
  return (
    <div className="msg ai">
      ...
      <div className="bubble amend-delta">
        <p>
          <b>Re-scored.</b> Here's how your prior picks shift against the new
          issue list:
        </p>
        <div className="ad-list">
          {deltas.map((d, i) => {
            ...
            return (
              <div
                className={
                  "ad-row " + dir + (d.significant ? " significant" : "")
                }
                key={i}
              >
                <div className="ad-race">
                  <div className="ad-tag">
                    {d.significant ? "REVISIT" : "unchanged"}
                  </div>
        ...
        <p className="ad-foot">
          Only races where the change is bigger than 5 pts get a REVISIT flag.
          The others stay on your ballot as-is.
        </p>
      </div>
    </div>
  );
...
function AmendRescoreOffer({ revisitCount, onWalkthrough, onDismiss }) {
    ...
    return (
      <div className="msg ai">
        ...
        <div className="bubble">
          <p>
            None of your prior picks crossed the threshold for a revisit.
  ...
  return (
    <div className="msg ai">
      ...
      <div className="bubble">
        <p>
          Want me to walk you through the {revisitCount}{" "}
          {revisitCount === 1 ? "race" : "races"} flagged for revisit, one at a
          time?
        </p>
        <div style={{ display: "flex", gap: 8, marginTop: 10 }}>
          <button className="rescore-yes" onClick={onWalkthrough}>
            Yes, walk me through them →
          </button>
          <button className="rescore-no" onClick={onDismiss}>
  ...
  return (
    <div className="be-modal-overlay" onClick={onClose}>
      <div className="be-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="be-lede">
          You've decided <b>{Object.keys(decisions).length}</b> of{" "}
          {Object.keys(decisions).length + racesRemaining} races. Copy the
          prompt below and paste it into any chatbot — Claude, ChatGPT, Gemini,
          Grok — to pick up where you left off. Voter Choice runs on AI budget
          that costs us money; we'd rather hand you off than burn through ours.
        </p>
        ...
        <div className="be-extras">
          <button
            ...
            onClick={() => onSaveProfile && onSaveProfile()}
          >
        ...
        <footer className="be-foot">
          Your address never leaves this device. The portable prompt above
          contains your issues + draft picks + the races still to decide — no
  ...
  return (
    <section className="be-byok" aria-labelledby="be-byok-ttl">
      ...
      <p className="be-tipjar">
        ...
        <a
          onClick={() => {
            window.__navigate && window.__navigate("tip");
            onClose && onClose();
          }}
          role="link"
          tabIndex={0}
...
function buildPortablePrompt({ address, issues, decisions, racesRemaining }) {
  ...
  const picks = Object.entries(decisions)
    .map(([raceId, d]) => {
  ...
  const remainingList = remainingRaces
    .map((r) => {
      const cands =
        r.candidates && r.candidates.length > 0
          ? r.candidates
              .map((c) => `${c.name} (${(c.party || "").slice(0, 1)})`)
              .join(" vs. ")
  ...
  return (
    <div className="be-modal-overlay" onClick={onClose}>
      <div className="be-modal pr-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="be-lede">
          If you saved your profile from a previous session, drop the .txt here.
          Your priorities and draft picks restore. Your address is still kept on
          this device only.
        </p>
        ...
        <footer className="be-foot">
          Your profile lives only on the device you saved it from. We don't
          store profiles on our servers — they'd just be another tracking
          vector.
        </footer>
      </div>
    </div>
...
const SAMPLE_RESUME_PROFILE = {
  issues: [
    {
      ...
      stance:
        "voter favors lower drug prices and Medicare drug-price negotiation",
      confidence: "clear",
  ...
  decisions: {
    "us-house-tx7": {
      pick: "Jordan Hartman",
      party: "D",
      why: "previously saved — strong on healthcare",
      candidateName: "Jordan Hartman",
    },
    "governor-tx": {
      pick: "Beto O\u2019Rourke",
      party: "D",
      why: "previously saved — grassroots funding base",
...
function CompareModal({
  ...
  function displayLabel(cand, idx) {
    ...
    const id = getCandidateIdentity(cand, {
      blindMode,
      ...
      <div className="cmp-modal v2" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="cmp-roster">
          {candidates.map((c, i) => {
            ...
            return (
              <div
                className={"cmp-roster-card " + (lab.isBlind ? "blind" : "")}
                key={c.id}
              >
        ...
        <div className="cmp-issues">
          {issues.map((iss) => (
            <div className="cmp-issue-panel" key={iss.canonicalIssue}>
              ...
              {candidates.map((c, ci) => {
                const lab = labels[ci];
                const entry = alignmentBlk?.entries?.find(
                ...
                if (!score && entry?.unavailable) {
                  body = (
                    <div className="cmp-score-row na">
                    ...
                    <>
                      ...
                      {hasVotes && (
                        ...
                        >
                          {isExpanded
                            ? "▴ Hide votes"
                            : `▾ View the ${score.contributingVotes.length} ${score.contributingVotes.length === 1 ? "vote" : "votes"}`}
                        </button>
                      )}
                      {isExpanded && hasVotes && (
                        <div className="cmp-votes">
                          {score.contributingVotes.map((v, vi) => {
                            ...
                            const cmpNum = cmpHasNum
                              ? v.billTitle.split(" · ")[0]
                              : "";
                            const cmpTtl = cmpHasNum
                              ? v.billTitle.split(" · ")[1]
                              : v.billTitle || "";
                            return (
                              <div className="cmp-vote" key={vi}>
                                ...
                                {v.narrative && (
                                  <p className="cmp-vote-narr">
                                    {window.anonymizeText
                                      ? window.anonymizeText(v.narrative, {
                                ...
                                <div className="cmp-vote-cite">
                                  {v.source?.url ? (
                                    ...
                                    <span>
                                      {v.source?.name || "Source pending"}
                                    </span>
                                  )}
                                  {(v.sources || [])
                                    .filter((s) => s.url !== v.source?.url)
                                    .map((s, si) => (
                                      <span key={si}>
                                        {s.url ? (
                                          <a
          ...
          <div className="cmp-issue-panel funding">
            <div className="cmp-issue-head">
              ...
              <div className="cmp-issue-stance">
                  ...
                  <div className="cmp-cand-tag">
                    ...
                    {c.totalRaised && (
                      <span className="cmp-total">
                        {window.__formatDollars
                          ? window.__formatDollars(c.totalRaised)
                          : "$" + c.totalRaised}
                      </span>
                    )}
                  </div>
        ...
        {anyBlind && (
          <footer className="cmp-foot">
            <span className="ic">⚠</span>
            <span className="cmp-foot-text">
              Candidate identities are hidden so you decide on the record. Tap{" "}
              <b>Reveal</b> at the top when you're ready to see who's who.
            </span>
          </footer>
        )}
      </div>
      ...
      <div className="av-panel" onClick={(e) => e.stopPropagation()}>
        <header className="av-head">
          <div>
            ...
            <h3>
              {allVotes.length} votes across {issueLabels.length} of your issues
            </h3>
          </div>
          <button className="be-x" onClick={onClose} aria-label="Close">
            ×
        ...
        <div className="av-filters">
          <button
            className={"av-filter " + (filter === "all" ? "active" : "")}
          ...
          {issueLabels.map((ci) => {
            ...
            return (
              <button
                key={ci}
                className={"av-filter " + (filter === ci ? "active" : "")}
          ...
          {filtered.map((v, i) => {
            ...
            return (
              <div className="av-vote" key={i}>
                ...
                {v.narrative && (
                  <p className="av-vote-narr">
                    {window.anonymizeText
                      ? window.anonymizeText(v.narrative, anonCtx)
                      : v.narrative}
                  </p>
                )}
        ...
        <footer className="av-method">
          ...
          <ul className="av-method-sources">
            <li>
              ...
              <a
                ...
                rel="noopener noreferrer"
              >
                OpenStates · state legislature records
              </a>
            </li>
            <li>
              Narrative context:{" "}
          ...
          <p className="av-method-disclaim">
            We don't generate vote claims from AI — if a vote isn't in our
            database, we don't show it. Every claim on every card links to a
            primary source.
          </p>
        </footer>
      </div>
    ...
    >
      ...
      >
        ...
        <footer className="sx-foot">
          ...
          <a className="sx-foot-link" href="/terms">
            Terms of use →
          </a>
          <a
            className="sx-foot-link"
      ...
      <div className="gf-wrap">
        <div className="gf-card">
          ...
          <p className="gf-tip">
            ...
            <code>123 Main St, Springfield, IL 62701</code>. If you typed a full
              ...
              {onBack && (
                <div className="nc-foot">
                  ...
                  <p className="nc-privacy">
                    Privacy: don't paste your name, address, phone number, or
                    email — only the ballot text.
                  </p>
                </div>
              )}
            </>
    ...
    >
      ...
      <ul>
        ...
        <li>
          ...
          and your state legislature's official records.
        </li>
      </ul>
      <p>
      ...
      <ul>
        ...
        <li>
          State candidates: your state's ethics commission or campaign finance
          disclosure office.
        </li>
        <li>
...
function TipJarPage({ onBack }) {
  return (
    <StaticPage
      onBack={onBack}
      eyebrow="Tip jar"
      title="Keep the community AI budget alive."
    >
      ...
      <p className="tip-note">
        One-time card payment · no account needed · Voter Choice never sees your
        card
      </p>
      ...
      <ul>
        <li>
          <b>Anthropic API spend</b> — the AI chat budget that runs out when too
          many voters use it at once.
        </li>
        <li>
      ...
      <p>
        Voter Choice is built by <b>Grey Bird LLC</b>. No ads, no tracking, no
        accounts, no data sales. Tips and small individual contributions are the
        only revenue.
      </p>
    </StaticPage>
  );
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        sign-ups. Across visits, your browser's localStorage keeps only your{" "}
        <b>language preference</b>, your <b>issues</b>, a{" "}
        <b>county-level location</b> (never your street address), and
        (optionally) a <b>bring-your-own Anthropic key</b>. Your{" "}
        <b>precise address</b> and your <b>in-progress assessment</b> are kept
        only for the current browser tab and are cleared when you close it. None
      ...
      <p>
        ...
        and contest lookup. We do not intentionally log or store your address on
        our servers, and we do not include it in the AI chat prompt. In your
        browser it is held only for the current tab and cleared when you close
        it — only a county-level location is kept across visits.
      </p>
        ...
        <section className="hp-hero">
          <div>
            <div className="eyebrow">
              <span className="star">★</span> November 3, 2026 · America's 250th
              election
            </div>
            <h1>
              Hold Congress to its <em>record.</em>
            </h1>
            <p className="lede">
              All 435 House seats and 33 Senate seats are on the ballot. Before
              you vote, see how your incumbents actually voted — and who paid
              for the campaign.
            </p>
            ...
            <div className="addr-card">
              ...
              {addrWhyOpen && (
                <div
                  ...
                  onClick={() => setAddrWhyOpen(false)}
                >
                  <div
                    className="addr-why-modal"
                    onClick={(e) => e.stopPropagation()}
                  >
                    <button
                      className="addr-why-close"
                      onClick={() => setAddrWhyOpen(false)}
                      aria-label="Close"
                    >
                      ×
                    ...
                    <p>
                      We use your address to pull local voting information so
                      you know exactly when and where to go vote and what IDs
                      are needed. So you have all the information you need to
                      support or vote against your representative and make a
                      change.
                    </p>
                  </div>
                </div>
              ...
              <div className="row">
                ...
                />
                <button className="go" onClick={submit} disabled={!addr.trim()}>
                  Pull my representatives →
                </button>
              </div>
              <div className="hint">
                <span>
                  <span className="dot"></span>No account
                </span>
                <span>
                  <span className="dot"></span>No tracking
                </span>
                <span>
                  <span className="dot"></span>Civic API · address never stored
                </span>
              </div>
            </div>
...
function ColdOpenView({ address, onLock, savedIssues, contextNote }) {
  const [phase, setPhase] = useStateV(
    savedIssues && savedIssues.length ? "review" : "prompt",
  );
    ...
    streamChatReply(
      ...
      },
      {
        ...
        onError: (_reason, meta) => {
          const blk = meta?.code
            ? resolveChatBlock(meta.code)
            : { budget: false, message: null };
    ...
    <>
      ...
      <div className="coldopen">
        <div className="co-context">
          <b>{address}</b> ·{" "}
          {contextNote ||
            `${RACES.length} ${RACES.length === 1 ? "race" : "races"} on your ballot`}
        </div>
        ...
        <div className="msg ai">
          ...
          <div className="bubble">
            <p>
              ...
              their record, I want to know what you're judging them on.
            </p>
        ...
        {phase === "prompt" && (
          <>
            ...
            >
              <button className="sc" onClick={fillSample}>
                Not sure where to start — show me an example
              </button>
              ...
              <div className="bubble">
                {thinking ? (
                  ...
                  <p>
                    Here are{" "}
                    <b>
                      {issues.length} starter issue
                      {issues.length !== 1 ? "s" : ""}
                    </b>{" "}
                    to work from. Re-rank, rename, or remove so they match what
                    you care about. Once you lock these in, every candidate's
                    record gets scored against this list, vote by vote.
                  </p>
                )}
              </div>
            </div>
            ...
            {phase === "review" && (
              <div className="themes-card">
                <div className="th-head">
                  ...
                  <span className="of">
                    {issues.length} issues · edit freely
                  </span>
                </div>
                <p className="th-sub">
                  Use the arrows to re-rank · click a name to rename · I show my
                  work so you can correct me.
                </p>
                ...
                <div className="th-foot">
                  ...
                  >
                    Lock these in &amp; start the ballot →
                  </button>
                </div>
              </div>
            )}
...
const CHAT_BUDGET_CODES = new Set([
  "BUDGET_SOFT_CLOSE",
  "BUDGET_HANDOFF",
  "BUDGET_EXHAUSTED",
]);
...
function WorkspaceView({
        ...
        ? [
            {
              ...
              party: prev.party || null,
              why: prev.why || "",
            },
          ]
        : [];
    const party =
      getCandidateParty(activeRace.id, candidate.name)?.code || null;
    ...
    if (picks.length >= seats) {
      setTimeout(() => {
        const nextIdx = races.findIndex(
          (r, i) => i > activeIdx && !decisions[r.id] && r.id !== activeRace.id,
        );
  ...
  const isEmptyNonPropRace =
    !isProposition &&
    (!activeRace.candidates || activeRace.candidates.length === 0);
  ...
  useEffectV(() => {
    ...
    const sc = getRealStateCode();
    if (!sc) {
      setRealStateData(null);
      return undefined;
    }
    getStateData(sc).then((d) => {
      if (active && d) setRealStateData(d);
    });
    return () => {
      active = false;
    };
  ...
  const sdBase =
    realStateData || getFallbackStateData(getRealStateCode() || "");
  ...
  const sd = realResWs
    ? { ...sdBase, resources: { ...sdBase.resources, ...realResWs } }
    : sdBase;
  // District: prefer logistics (civic), fall back to ballot extraction.
  const houseRaceWs = races.find((r) => /house/i.test(r.label || ""));
  const districtCodeWs =
    (logistics && logistics.congressionalDistrict) ||
    (houseRaceWs
      ? deriveDistrictCode(houseRaceWs.label, getRealStateCode() || "")
      : null) ||
    "";
  ...
  const earlyWindowWs = (() => {
    ...
    if (
      sd.earlyVoting &&
      sd.earlyVoting.available &&
      sd.earlyVoting.startDate
    ) {
  ...
  const pollingInfoWs =
    logistics && logistics.pollingPlace
      ? {
  ...
  return (
    <div className="ws-shell">
      <AppNav />
      <PollingStatusBar pollingInfo={pollingInfoWs} stateData={sd} rows={[]} />
      <div
        className="ws-wrap"
      ...
      >
        ...
        <aside className="ws-rail">
          ...
          <div className="priorities">
            <div className="top">
              ...
              <button className="edit" onClick={onEditIssues}>
                Edit
              </button>
            </div>
            <ol>
              {issues.map((iss) => (
                <li key={iss.canonicalIssue}>{iss.interpretation}</li>
              ))}
            </ol>
          </div>
          ...
          <div className="foot">
            <a
              onClick={() => {
                if (
                  confirm(
                    "Restart session? This clears your draft ballot and issues.",
                  )
                )
                  window.__voterChoiceReset && window.__voterChoiceReset();
              }}
              role="link"
              tabIndex={0}
            >
        ...
        <section className="ws-chat">
          <header className="head">
            ...
            <div className="title">
              <small>
                Race {activeIdx + 1} of {races.length}
              </small>
              {activeRace.label}
            </div>
            <div className="h-act">
              {!isProposition && (
                <button
                  ...
                  title={
                    blindMode ? "Show candidate names" : "Hide candidate names"
                  }
                >
                  <svg
                    className="blind-toggle-ic"
                    viewBox="0 0 24 24"
                    width="14"
                    height="14"
                    fill="none"
          ...
          <div className="body">
            {!isProposition &&
              richCandidates.map((cand, idx) => {
                const alignmentEntry = alignmentBlk?.entries?.find(
                  (e) => e.candidateId === cand.id,
                );
                  ...
                  <div className="msg ai" key={cand.id}>
                    ...
                    <div className="bubble">
                      {idx === 0 ? (
                        isBlind ? (
                          <p>
                            {richCandidates.length} candidate
                            {richCandidates.length === 1 ? "" : "s"} for{" "}
                            <b>{activeRace.label}</b>
                            {(activeRace.voteForN || 1) > 1
                              ? ` — vote for ${activeRace.voteForN}`
                              : ""}
                            . I'm hiding their names so you decide on the
                            record, not the brand. Here's{" "}
                            <b>Candidate {alias}</b>:
                          </p>
                        ) : (
                          <p>
                            This is <b>{activeRace.label}</b>
                            {(activeRace.voteForN || 1) > 1
                              ? `, vote for ${activeRace.voteForN}`
                              : ""}
                            . {richCandidates.length} on your ballot. Here's the{" "}
                            {cand.incumbent
                              ? "incumbent"
                              : "longer-tenure candidate"}{" "}
                            — each percentage is clickable to see the votes
                            behind it.
                          </p>
                        )
                      ) : isBlind ? (
                        <p>
                          And <b>Candidate {alias}</b>:
                        </p>
                      ) : (
                        <p>
                          And the{" "}
                          {cand.incumbent
                            ...
                            : alignmentEntry?.scores === null
                              ? "challenger — no legislative record yet"
                              : "challenger"}
                          :
                        </p>
                      )}
                      <CandidateCard
                        ...
                        onPick={() => {
                          ...
                          const hasRecord = !!(
                            ...
                            alignmentEntry.scores.length > 0
                          );
                          const topIssue =
                            issues[0]?.interpretation || "my priorities";
                          const label = isBlind
                            ? `Candidate ${alias}`
                            : cand.name.split(" ").pop();
                          const why = hasRecord
                ...
                return writeInNames.map((wiName) => {
                  ...
                  return (
                    <div className="msg ai" key={wiName}>
                      ...
                      <div className="bubble">
                        <p>
                          <b>✎ Write-in</b> — this race has{" "}
                          {seats > 1 ? `${seats} seats` : "a seat"} open for a
                          write-in candidate.
                          {seats > 1 &&
                            ` You can fill up to ${seats} picks total.`}
                        </p>
                        <div
                          style={{
                            display: "flex",
                        ...
                        >
                          <input
                            ...
                            value={wiText}
                            onChange={(e) =>
                              setWriteInTexts((prev) => ({
                                ...prev,
                                [wiKey]: e.target.value,
                              }))
                            }
                            style={{
                              flex: "1 1 160px",
              ...
              <div className="msg ai">
                ...
                <div className="bubble">
                  {activeRace.section === "Judicial Retention" ? (
                    <p>
                      This is a judicial retention question — should this judge
                      stay in office?
                    </p>
                  ) : (
                    <p>
                      This is <b>{activeRace.label}</b>, a ballot proposition.
            ...
            {isEmptyNonPropRace && (
              <div className="msg ai">
                ...
                <div className="bubble">
                  <p>
                    We couldn't read the candidates for{" "}
                    <b>{activeRace.label}</b> — the ballot text for this race
                    may be unclear or missing. Please check your{" "}
                    <a
                      href={
                        sd.resources?.sampleBallotLookup || "https://vote.gov/"
                      }
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ color: "inherit", textDecoration: "underline" }}
            ...
            {chatTimeouts && chatTimeouts[activeRace.id] && (
              <AITimeoutBanner
                ...
                message={
                  typeof chatTimeouts[activeRace.id] === "string"
                    ? chatTimeouts[activeRace.id]
                    : undefined
                }
              />
            )}
                ...
                <div className="bubble">
                  ...
                  {(() => {
                    ...
                    if (seats > 1 && have < seats) {
                      return (
                        <p style={note}>
                          This race elects {seats}. You've picked {have} —
                          choose {seats - have} more above, or move on.
                        </p>
                      );
                    }
                    return (
                      <p style={note}>
                        You can edit the note in the ballot pane any time. Or
                        jump to a different race.
                      </p>
                    );
                  })()}
                </div>
          ...
          <div className="ws-input">
            <div className="chips">
              <button className="chip">
                ...
                {(() => {
                  ...
                  const isFirstBlind =
                    blindMode && !revealedCandidates?.has(firstC.id);
              ...
              <button className="chip" onClick={skipRace}>
                Skip — I've decided
              </button>
            </div>
            ...
            <div className="meta">
              <span>
                Auto-saving to your device · nothing leaves your browser
              </span>
              <span>
                Race {activeIdx + 1} / {races.length}
              </span>
            </div>
          </div>
        </section>
      ...
      {onEditIssues && issues && issues.length > 0 && (
        <div className="b-issues-edit">
          <div className="b-issues-head">
            ...
            <button className="b-issues-btn" onClick={onEditIssues}>
              Edit ranking →
            </button>
          </div>
    ...
    <div className="b-foot exhausted">
      <div className="bx-banner">
        ...
        <div>
          ...
          <div className="bx-banner-sub">
            Your draft is safe. Two ways to keep going:
          </div>
        </div>
      </div>
      ...
      <button className="bx-cta primary" onClick={onOpenByok}>
        ...
        <span className="bx-cta-lab">
          ...
          <span className="bx-cta-sub">
            Keep chatting here · key stays on device
          </span>
        </span>
        <span className="arrow">→</span>
      </button>
      ...
      <button className="bx-cta" onClick={onContinueElsewhere}>
        ...
        <span className="bx-cta-lab">
          ...
          <span className="bx-cta-sub">
            Copy your research into Claude, ChatGPT, Gemini…
          </span>
        </span>
        <span className="arrow">→</span>
      </button>
      ...
      <div className="bx-secondary">
        <button disabled={!canPrint} onClick={onPrint}>
          Print ballot →
        </button>
      ...
      <p className="bx-tip">
        ...
        <a
          onClick={() => onNavigate && onNavigate("tip")}
          role="link"
          tabIndex={0}
        >
          Tip jar
...
function PrintView({ address, issues, decisions, onBack }) {
  ...
  const districtLabel =
    (logisticsPrint && logisticsPrint.congressionalDistrict) ||
    (houseRace
      ? deriveDistrictCode(houseRace.label, getRealStateCode() || "")
      : null) ||
    "";
  const lookupHost = (
    sd?.resources?.pollingPlaceLookup ||
    sd?.resources?.stateElectionWebsite ||
    "https://vote.gov/"
  )
    .replace(/^https?:\/\//, "")
    .replace(/\/$/, "");
      ...
      <div className="print-wrap">
        ...
        <div className="print-sheet">
          <header className="ph-head">
            ...
            <div className="r">
              <b>{sd.stateName || getRealStateCode()}</b>
              <br />
              {address}
              <br />
          ...
          <div className="voter-meta">
            ...
            <div className="cell cell-bring">
              ...
              {!sd.votingRules.idRequired ? (
                <div className="v">
                  {sd.votingRules.idNote || "No ID required for most voters."}
                </div>
              ) : acceptedIds.length > 0 ? (
                <>
                ...
                <div className="v">
                  {sd.votingRules.idNote || "ID required."} Confirm the exact
                  accepted-ID list at {lookupHost}.
                </div>
              )}
            </div>
            <div className="cell">
              <div className="k">Before you go</div>
              <div className="v">
                Look up your polling place, hours &amp; early voting at{" "}
                {lookupHost}
              </div>
            </div>
          </div>
            ...
            {Object.entries(sections).map(([section, items]) => (
              <div className="ballot-group" key={section}>
                ...
                {items.map(({ race, decision }) => {
                  ...
                  const picks =
                    decision.picks && decision.picks.length
                      ? decision.picks
                      : [
                          {
                            candidateName: decision.pick,
...
function App() {
  ...
  const [activeRaceId, setActiveRaceId] = useStateA(
    saved?.activeRaceId || RACES[0].id,
  );
  ...
  useEffectA(() => {
    if (saved?.view === "workspace" && (saved?.issues || []).length > 0) {
      ...
      const sc = getRealStateCode();
      if (sc)
        applyRealStateResources(sc).then(() => setDataVersion((v) => v + 1));
  ...
  const [revealedCandidates, setRevealedCandidates] = useStateA(
    new Set(saved?.revealedCandidates || []),
  );
  ...
  function handleReset() {
    if (!confirm("Start over? This clears your draft ballot and issues."))
      return;
    try {
    ...
    if (racePatterns && Array.isArray(racePatterns.candidates)) {
      racePatterns = {
        ...
        candidates: racePatterns.candidates.map((c, i) => {
          const idn = getCandidateIdentity(c, {
            blindMode,
            revealed: revealedCandidates,
            index: i,
          });
      ...
      <NavProvider value={navValue}>
        {view === "home" && (
          <HomeView
            ...
            onResumeSession={() => {
              if (issues.length || Object.keys(decisions).length)
                setView("workspace");
              else setView("coldopen");
            }}
          ...
          !(() => {
            ...
            <div className="pd-toast" role="status">
              <div className="pd-toast-head">
                <div>
                  <div className="pd-toast-ttl">
                    You decided all {RACES.length} races.
                  </div>
                  <div className="pd-toast-sub">
                    Take your ballot to the booth — many polls don't allow
                    phones.
                  </div>
                </div>
                <button
