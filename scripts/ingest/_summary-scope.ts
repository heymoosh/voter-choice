...
async function main(){
  ...
  let total=0; for(const r of bySource){console.log(`  ${String(r.source).padEnd(12)} ${r.n}`); total+=r.n;}
...
main().catch(e=>{console.error("SCOPE FAILED:",e.message);process.exit(1);});
