export const meta = {
  ...
  description:
    "Independent 3-juror Opus panel labels the healthcare sub-issue gold sample BLIND (facet ∈ 5 + null) — ground truth for the cutover gate, independent of the Sonnet that produced the sub-tags.",
  phases: [
    {
      title: "Label",
      detail:
        "3 independent Opus jurors per facet batch, blind to the tagger; M2 retry",
      model: "opus",
    },
  ],
};
