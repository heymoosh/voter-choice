 ...
 * scenarios (all of SCENARIOS except 10a-polis-entry/11a-fieldmoneygap/
 * 11b-scalestates, none of which are automatable at all — see each one's
 * own note in parity-gallery-scenarios.ts) now resolves to exactly one of
 * STRUCTURAL_PROBES above (class-diff or marker) or this map — silently
 ...
 * Phase 2 of docs/operations/keystone-fidelity-fix-plan-2026-07-08.md
 * exists to close. STOP-SHIP 2026-07-09 moved 3 of these
