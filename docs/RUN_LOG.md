...
- **Tag:** `superpowers-phase6-complete`
- **Status:** ✓
- **Summary:** e2e 182/182, coverage 29.9%, LOC 7618, complexity avg 5.33, scope adherence ?


### Phase 6 forward — spec-kit (auto)

- **Date:** 2026-05-12T13:36:15.814Z
- **Branch:** `experiment/spec-kit-r1`
- **Tag:** `spec-kit-phase6-complete`
- **Status:** ✓
- **Summary:** e2e 110/110, coverage 24.3%, LOC 9730, complexity avg 5.95, scope adherence N/A
...
- **Tag:** `vanilla-phase6-complete`
- **Status:** ✓
- **Summary:** e2e 179/182, coverage 22.8%, LOC 7087, complexity avg 5.27, scope adherence ?


### Phase 5 forward — compound-engineering (auto)

- **Date:** 2026-05-12T12:04:51.660Z
- **Branch:** `experiment/compound-engineering-r1`
- **Tag:** `compound-engineering-phase5-complete`
- **Status:** ✓
- **Summary:** e2e 154/154, coverage N/A%, LOC 7007, complexity avg 6.50, scope adherence N/A
...
- **Branch:** `experiment/spec-kit-r1`
- **Tag:** `spec-kit-phase5-complete`
- **Status:** ✓
- **Summary:** e2e 110/110, coverage 25.2%, LOC 8175, complexity avg 5.83, scope adherence N/A


### Phase 5 forward — bmad (auto)

- **Date:** 2026-05-12T10:32:18.032Z
- **Branch:** `experiment/bmad-r2`
- **Tag:** `bmad-phase5-complete`
- **Status:** ✓
- **Summary:** e2e 144/144, coverage 30.9%, LOC 7261, complexity avg 6.07, scope adherence ?
...
- **Branch:** `experiment/compound-engineering-r1`
- **Tag:** `compound-engineering-phase4-complete`
- **Status:** ✓
- **Summary:** e2e 110/110, coverage ?%, LOC 5504, complexity avg 6.90, scope adherence ?


### Phase 4 forward — superpowers (auto)

- **Date:** 2026-05-12T09:13:51.894Z
- **Branch:** `experiment/superpowers-r1`
- **Tag:** `superpowers-phase4-complete`
- **Status:** ✓
- **Summary:** e2e 112/112, coverage 35.6%, LOC 4452, complexity avg 5.77, scope adherence ?


### Phase 4 forward — spec-kit (auto)

- **Date:** 2026-05-12T08:39:14.236Z
- **Branch:** `experiment/spec-kit-r1`
- **Tag:** `spec-kit-phase4-complete`
- **Status:** ✓
- **Summary:** e2e 80/80, coverage 23.9%, LOC 5746, complexity avg 5.63, scope adherence ?


### Phase 4 forward — bmad (auto)

- **Date:** 2026-05-12T08:15:20.147Z
- **Branch:** `experiment/bmad-r2`
- **Tag:** `bmad-phase4-complete`
- **Status:** ✓
- **Summary:** e2e ?/104, coverage 34.0%, LOC 5238, complexity avg 5.70, scope adherence N/A


### Phase 4 forward — vanilla (auto)

- **Date:** 2026-05-12T07:50:06.427Z
- **Branch:** `experiment/vanilla-r1`
- **Tag:** `vanilla-phase4-complete`
- **Status:** ✓
- **Summary:** e2e 106/106, coverage 34.2%, LOC 4160, complexity avg 4.93, scope adherence ?


### Phase 3 forward — compound-engineering (auto)

- **Date:** 2026-05-12T07:26:52.926Z
- **Branch:** `experiment/compound-engineering-r1`
- **Tag:** `compound-engineering-phase3-complete`
- **Status:** ✓
- **Summary:** e2e 62/62, coverage ?%, LOC 4868, complexity avg 6.56, scope adherence ?
...
- **Branch:** `experiment/spec-kit-r1`
- **Tag:** `spec-kit-phase3-complete`
- **Status:** ✓
- **Summary:** e2e 56/56, coverage 22.1%, LOC 4795, complexity avg 5.20, scope adherence ?


### Phase 3 forward — bmad (auto)

- **Date:** 2026-05-12T06:08:45.802Z
- **Branch:** `experiment/bmad-r2`
- **Tag:** `bmad-phase3-complete`
- **Status:** ✓
- **Summary:** e2e 82/82, coverage 18.4%, LOC 4354, complexity avg 5.00, scope adherence N/A


### Phase 2 forward — compound-engineering (auto)

- **Date:** 2026-05-12T04:58:50.384Z
- **Branch:** `experiment/compound-engineering-r1`
- **Tag:** `compound-engineering-phase2-complete`
- **Status:** ✓
- **Summary:** e2e 42/42, coverage ?%, LOC 2385, complexity avg 5.76, scope adherence 0.61


### Phase 2 forward — superpowers (auto)

- **Date:** 2026-05-12T04:39:30.529Z
- **Branch:** `experiment/superpowers-r1`
- **Tag:** `superpowers-phase2-complete`
- **Status:** ✓
- **Summary:** e2e 42/42, coverage 34.7%, LOC 2036, complexity avg 4.17, scope adherence 0.20
