...
Issues, monitoring gaps, data-quality concerns, and enhancement ideas. **Reorganized 2026-06-07 by product phase** (model below). Nothing deleted — resolved items are archived at the bottom.
...
**Phase 1 UX — fold into the redesign (don't pre-build):**
...
## ✅ Resolved (archive — preserved as record, not deleted)
