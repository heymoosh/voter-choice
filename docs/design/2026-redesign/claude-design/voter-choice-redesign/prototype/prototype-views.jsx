    ...
    <>
      ...
      <div className="coldopen">
        <div className="co-context">
          <b>{address}</b> · Harris County, TX‑7 · 5 races on your ballot
        </div>
        ...
        <div className="msg ai">
          ...
          <div className="bubble">
            <p>
              I've pulled your sample ballot. Before I walk you through races, I
              want to know what <i>you're</i> judging candidates on — in your
              words, not from a pre-built list.
            </p>
              ...
              <div className="bubble">
                {thinking ? (
                  ...
                  <p>
                    ...
                    , each anchored in the words you actually used. Re-rank,
                    rename, or remove. Once you lock these in, every candidate's
      ...
      >
        ...
        <aside className="ws-rail">
          ...
          <div className="foot">
            ...
            <a
              onClick={onViewPartyGate}
              style={{ cursor: "pointer" }}
              role="link"
              tabIndex={0}
            >
              See party-gate (TX primary)
            </a>
          </div>
        </aside>
                  ...
                  <div className="msg ai" key={cand.id}>
                    ...
                    <div className="bubble">
                      {idx === 0 ? (
                        isBlind ? (
                          <p>
                            Two candidates for <b>{activeRace.label}</b>. I'm
                            hiding their names so you decide on the record, not
                            the brand. Here's <b>Candidate {alias}</b>:
                          </p>
                        ) : (
                          <p>
                            This is <b>{activeRace.label}</b>. Two on your
                            ballot. Here's the{" "}
                            {cand.incumbent
                              ? "incumbent"
        ...
        <div className="print-sheet">
          ...
          <div className="voter-meta">
            ...
            <div className="cell">
              ...
              <div className="v">U.S. House TX‑7</div>
            </div>
                ...
                {items.map(({ race, decision }) => (
                  <div className="br checked" key={race.id}>
                    ...
                    <div>
                      ...
                      {decision.why && (
                        <div className="my-note">"{decision.why}"</div>
                      )}
                    </div>
                  </div>
                ))}
