...
const RACES = [
  ...
  },
  {
    id: "prop-7",
    section: "Propositions",
    label: "Prop 7 — Voter ID expansion",
    decided: false,
    candidates: [],
  },
];
...
const PROPOSITION_KIND_META = {
  constitutional: {
    ...
    tone: "binding",
    blurb:
      "A YES vote changes the Texas constitution. This is binding — if it passes statewide, it becomes law.",
  },
  bond: {
  ...
  primary_advisory: {
    ...
    tone: "advisory",
    blurb:
      "In a TX primary, propositions are ADVISORY — they signal what the party’s voters care about but don’t become law on their own. They influence the party platform + how legislators prioritize bills.",
  },
  advisory: {
